...
async def login():
    ...
    auth_url = 'https://api.whattogrill.com/login?client_id=79i5hkaq33a89b9587mj9gm2gq&response_type=code&scope=openid&redirect_uri=https://auth.whattogrill.com/callback&code_challenge=sXS5V41S7Y1AmuO7YRk4dvwPvZ5CpB01INDHn_6I-Wg&code_challenge_method=S256'
